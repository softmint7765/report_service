...
export default function Earning() {
    ...
    const handleApi = () => {
        ...
        if (token !== null || token !== undefined) {
            ...
            let transactionUrl = "https://uat.softmintdigital.com/reportservice/transaction/earningreport?pageNo=0&pageSize=" + numOfRows;
                                    ...
                                    <CardBody>
                                        <Row>
                                            ...
                                            <div style={{display:"flex"}}>
                                                <div>
                                                    <select value={value} onChange={handleChange} style={{padding:"6px",marginTop:"30px",borderRadius:"5px",width:"150px"}}>
                                                        <option>ALL</option>
                                                        <option value="RoleId 1">White LABLE</option>
                                                        <option value="RoleId 2">RESELLER </option>
                                                        <option value="RoleId 3">SUPER DISTRIBUTOR </option>
                                                        <option value="RoleId 3">RETAILER </option>
                                                        <option value="RoleId 3">API USER </option>
                                                        <option value="RoleId 3">ALL </option>
                                                    </select>
                    ...
                    <div className="col">
                        <Card className="shadow">
                            <CardHeader className=" border-0">
                                <h3 className=" mt-0">Earning Report</h3>
